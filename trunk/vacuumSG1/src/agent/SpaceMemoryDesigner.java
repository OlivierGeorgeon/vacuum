...
public class SpaceMemoryDesigner {
	...
	public void paintSpaceMemory( Graphics g , ArrayList<IPlace> placeList , BehaviorState behaviorState ) {
		...
		ref1.translate( -behaviorState.getAnimPosition() * SCALE , 0 ) ;
		ref1.rotate( behaviorState.getAnimOrientation() , WIDTH , HEIGHT ) ;
		...
		placeAgent.translate( WIDTH + behaviorState.getAnimPosition() * SCALE , HEIGHT ) ;
		// placeAgent.rotate(Math.PI/2);
		placeAgent.scale( SCALE / 100f , SCALE / 100f ) ;
		placeAgent.rotate( -behaviorState.getAnimOrientation() ) ;
